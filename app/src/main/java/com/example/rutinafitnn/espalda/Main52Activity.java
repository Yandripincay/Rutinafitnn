...
public class Main52Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener,YouTubePlayer.PlaybackEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYoutube=(YouTubePlayerView)findViewById(R.id.video_youtube52);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean fuerestaurado) {
        if (!fuerestaurado){
            youTubePlayer.cueVideo("zr1Lg9I-UIc");
        }
    }
