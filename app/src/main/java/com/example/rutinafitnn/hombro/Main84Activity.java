...
public class Main84Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener,YouTubePlayer.PlaybackEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYoutube=(YouTubePlayerView)findViewById(R.id.video_youtube84);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean fuerestaurado) {
        if (!fuerestaurado){
            youTubePlayer.cueVideo("oBbSiiTj2C0");
        }
    }
