...
public class Main61Activity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener,YouTubePlayer.PlaybackEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mYoutube=(YouTubePlayerView)findViewById(R.id.video_youtube61);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean fuerestaurado) {
        if (!fuerestaurado){
            youTubePlayer.cueVideo("4KB8MyCtOR8");
        }
    }
